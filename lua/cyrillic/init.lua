...
-- Version: 0.2
-- License: GPLv3
-- URL: http://github.com/Xeliotropp/bulgarian-phonetic.nvim
...
M.setup = function(opts)
  ...
  if not opts.no_cyrillic_abbrev and not vim.g.no_plugin_abbrev then
    vim.cmd [[
      ...
      cabbrev <expr> вя	getcmdtype()==':' && getcmdline()=="вя"	? "wq"	: "яа"
    ]]
  end
	vim.keymap.set('', 'ч', '`', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'я', 'q', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'в', 'w', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'е', 'e', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'р', 'r', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'т', 't', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ъ', 'y', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'у', 'u', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'и', 'i', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'о', 'o', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'п', 'p', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ш', '[', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щ', ']', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'а', 'a', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'с', 's', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'д', 'd', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ф', 'f', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'г', 'g', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'х', 'h', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'й', 'j', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'к', 'k', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'л', 'l', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'з', 'z', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ь', 'x', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ц', 'c', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ж', 'v', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'б', 'b', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'н', 'n', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'м', 'm', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Ч', '~', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Я', 'Q', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'В', 'W', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Е', 'E', { desc = 'which_key_ignore' })
	...
	vim.keymap.set('', 'У', 'U', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'И', 'I', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'O', 'O', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'П', 'P', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Ш', '{', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Щ', '}', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'А', 'A', { desc = 'which_key_ignore' })
	...
	vim.keymap.set('', 'Л', 'L', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'З', 'Z', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ѝ', 'X', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Ц', 'C', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Ж', 'V', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Б', 'B', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'Н', 'N', { desc = 'which_key_ignore' })
	...
	vim.keymap.set('', 'ЗЗ', 'ZZ', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ЗЯ', 'ZQ', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'я:', 'q:', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'я/', 'q/', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'я?', 'q?', { desc = 'which_key_ignore' })

	vim.keymap.set('', 'чч', '``', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ч„', '`<', { desc = 'which_key_ignore' })
	vim.keymap.set('', '“ч', '`>', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чш', '`[', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чщ', '`]', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чШ', '`{', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чЩ', '`}', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ч„', "'<", { desc = 'which_key_ignore' })
	vim.keymap.set('', "'“", "'>", { desc = 'which_key_ignore' })
	...
	vim.keymap.set('', "ш'", "['", { desc = 'which_key_ignore' })
	vim.keymap.set('', "шч", '[`', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шД', '[D', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шИ', '[I', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шП', '[P', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шш', '[[', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шщ', '[]', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шц', '[c', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шд', '[d', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шф', '[f', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'ши', '[i', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шм', '[m', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шп', '[p', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шс', '[s', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шз', '[z', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'шШ', '[{', { desc = 'which_key_ignore' })
	vim.keymap.set('', "Щ'", "]'", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щД', ']D', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щИ', ']I', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щП', ']P', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щш', '][', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щщ', ']]', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щц', ']c', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щд', ']d', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щф', ']f', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щи', ']i', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щм', ']m', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щп', ']p', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щс', ']s', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щз', ']z', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'щШ', ']{', { desc = 'which_key_ignore' })

	vim.keymap.set('', 'мА', 'mA', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чА', '`A', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'А", "'A", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчА', 'g`A', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'А", "g'A", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мБ', 'mB', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чБ', '`B', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Б", "'B", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчБ', 'g`B', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'Б", "g'B", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мЦ', 'mC', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чЦ', '`C', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Ц", "'C", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчЦ', 'g`C', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'Ц", "g'C", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мД', 'mD', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чД', '`D', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Д", "'D", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчД', 'g`D', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'Д", "g'D", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мЕ', 'mE', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чЕ', '`E', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Е", "'E", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчЕ', 'g`E', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'Е", "g'E", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мФ', 'mF', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чФ', '`F', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Ф", "'F", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчФ', 'g`F', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'Ф", "g'F", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мГ', 'mG', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чГ', '`G', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Г", "'G", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчГ', 'g`G', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'Г", "g'G", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мХ', 'mH', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чХ', '`H', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Х", "'H", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчХ', 'g`H', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'Х", "g'H", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мИ', 'mI', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чИ', '`I', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'И", "'I", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчИ', 'g`I', { desc = 'which_key_ignore' })
	vim.keymap.set('', "г'И", "g'I", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'мЙ', 'mJ', { desc = 'which_key_ignore' })
	vim.keymap.set('', 'чЙ', '`J', { desc = 'which_key_ignore' })
	vim.keymap.set('', "'Й", "'J", { desc = 'which_key_ignore' })
	vim.keymap.set('', 'гчЙ', 'g`J', { desc = 'which_key_ignore' })
